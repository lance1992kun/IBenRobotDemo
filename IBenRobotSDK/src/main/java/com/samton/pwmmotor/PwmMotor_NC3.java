...
public class PwmMotor_NC3 {
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_NC3 instance = new PwmMotor_NC3();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_NC3 getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_NC3.class) {
                if (instance == null) {
                    instance = new PwmMotor_NC3();
                }
            }
        }
        return instance;
