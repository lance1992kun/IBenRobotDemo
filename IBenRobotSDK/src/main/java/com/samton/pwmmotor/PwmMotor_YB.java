...
public class PwmMotor_YB {
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_YB instance = new PwmMotor_YB();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_YB getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_YB.class) {
                if (instance == null) {
                    instance = new PwmMotor_YB();
                }
            }
        }
        return instance;
