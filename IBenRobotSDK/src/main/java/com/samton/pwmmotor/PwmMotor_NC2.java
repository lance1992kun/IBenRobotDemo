...
public class PwmMotor_NC2 {
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_NC2 instance = new PwmMotor_NC2();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_NC2 getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_NC2.class) {
                if (instance == null) {
                    instance = new PwmMotor_NC2();
                }
            }
        }
        return instance;
