...
public class PwmMotor_TEST1 {
     ...
     * 右手垂直时间点
     */
    private final static double RIGHT_ARM_VERTICAL = 1.60 * 1000000;
    /**
     * 右手水平时间点
     */
    private final static double RIGHT_ARM_HORIZONTAL = 2.2 * 1000000;
    /**
     * 头部左侧时间点
     */
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_TEST1 instance = new PwmMotor_TEST1();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_TEST1 getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_TEST1.class) {
                if (instance == null) {
                    instance = new PwmMotor_TEST1();
                }
            }
        }
        return instance;
