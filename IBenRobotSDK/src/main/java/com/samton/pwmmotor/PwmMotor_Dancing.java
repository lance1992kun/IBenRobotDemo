...
public class PwmMotor_Dancing {
     ...
     * 左手垂直时间点
     */
    private final static double LEFT_ARM_VERTICAL = 1.43 * 1000000;
    /**
     * 左手上抬45度
     */
    private final static double LEFT_ARM_UP_45 = 1.74 * 1000000;
    /**
     * 左手上抬60度
     */
    private final static double LEFT_ARM_UP_60 = 1.843 * 1000000;
    /**
     * 左手水平时间点
     */
    private final static double LEFT_ARM_HORIZONTAL = 2.10 * 1000000;
    /**
     * 右手垂直时间点
     */
    private final static double RIGHT_ARM_VERTICAL = 2.0 * 1000000;
    /**
     * 右手上抬45度
     */
    private final static double RIGHT_ARM_UP_45 = 1.685 * 1000000;
    /**
     * 右手上抬60度
     */
    private final static double RIGHT_ARM_UP_60 = 1.58 * 1000000;
    /**
     * 右手水平时间点
     */
    private final static double RIGHT_ARM_HORIZONTAL = 1.37 * 1000000;
    /**
     * 头部左侧时间点
     */
    private final static double HEAD_LEFT = 1.35 * 1000000;
    /**
     * 头部向左侧转30度
     */
    private final static double HEAD_LEFT_30 = 1.42 * 1000000;
    /**
     * 头部左侧回中间时间点
     */
    private final static double HEAD_LEFT_2_MIDDLE = 1.55 * 1000000;
    /**
     * 头部右侧时间点
     */
    private final static double HEAD_RIGHT = 1.75 * 1000000;
    /**
     * 头部向右侧转30度
     */
    private final static double HEAD_RIGHT_30 = 1.68 * 1000000;
    /**
     * 头部右侧回中间时间点
     */
    private final static double HEAD_RIGHT_2_MIDDLE = 1.55 * 1000000;
    /**
     * 头部在左侧的常量值
     */
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_Dancing instance = new PwmMotor_Dancing();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_Dancing getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_Dancing.class) {
                if (instance == null) {
                    instance = new PwmMotor_Dancing();
                }
            }
        }
        return instance;
...
//    }
     ...
     * 左胳膊上抬45度
     */
    public void leftArmUp45() {
        // 调整3号舵机
        config(3, (int) LEFT_ARM_UP_45, PERIOD_NS);
    }

    /**
     * 左胳膊上抬60度
     */
    public void leftArmUp60() {
        // 调整3号舵机
        config(3, (int) LEFT_ARM_UP_60, PERIOD_NS);
    }
     ...
     * 右胳膊上抬45度
     */
    public void rightArmUp45() {
        // 调整2号舵机
        config(2, (int) RIGHT_ARM_UP_45, PERIOD_NS);
    }

    /**
     * 右胳膊上抬60度
     */
    public void rightArmUp60() {
        // 调整2号舵机
        config(2, (int) RIGHT_ARM_UP_60, PERIOD_NS);
    }
...
//        }
     ...
     * 头部转向左侧30度
     */
    public void head2Left30() {
        // 调整0号舵机
        config(0, (int) HEAD_LEFT_30, PERIOD_NS);
    }
...
//        }
     ...
     * 头部转向右侧30度
     */
    public void head2Right30() {
        // 调整0号舵机
        config(0, (int) HEAD_RIGHT_30, PERIOD_NS);
    }
