...
import static com.samton.IBenRobotSDK.data.Constants.ROBOT_HEAD_POSITION;
...
public class PwmMotor_HG {
     ...
     * 左手垂直时间点
     */
    private final static double LEFT_ARM_VERTICAL = 910.4 * 1000;
    /**
     * 左手水平时间点
     */
    private final static double LEFT_ARM_HORIZONTAL = 1.51 * 1000000;
    /**
     * 右手垂直时间点
     */
    private final static double RIGHT_ARM_VERTICAL = 2.41 * 1000000;
    /**
     * 右手水平时间点
     */
    private final static double RIGHT_ARM_HORIZONTAL = 1.81 * 1000000;
    /**
     * 头部左侧时间点
     */
    private final static double HEAD_LEFT = 810.3 * 1000;
    /**
     * 头部左侧回中间时间点
     */
    private final static double HEAD_LEFT_2_MIDDLE = 1.41 * 1000000;
    /**
     * 头部右侧时间点
     */
    private final static double HEAD_RIGHT = 2.21 * 1000000;
    /**
     * 头部右侧回中间时间点
     */
    private final static double HEAD_RIGHT_2_MIDDLE = 1.39 * 1000000;
    /**
     * 头部在左侧的常量值
     */
     ...
     * 舵机管理器单例对象
     */
    private static PwmMotor_HG instance = new PwmMotor_HG();
     ...
     * @return 舵机管理器单例
     */
    public static PwmMotor_HG getInstance() {
        if (instance == null) {
            synchronized (PwmMotor_HG.class) {
                if (instance == null) {
                    instance = new PwmMotor_HG();
                }
            }
        }
        return instance;
